...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ResourcesComponent_Binding
    {
        ...
        static StackObject* BundleNameGetAsset_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = instance_of_this_method.BundleNameGetAsset(@bundleName, @prefab);
        ...
        {
            return ETModel.ResourcesComponent.Ins;
        }
        static void set_Ins_0(ref object o, object v)
        {
            ETModel.ResourcesComponent.Ins = (ETModel.ResourcesComponent)v;
        }
