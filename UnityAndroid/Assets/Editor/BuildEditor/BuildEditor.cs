...
namespace ETEditor
{
	...
	public class BuildEditor : EditorWindow
	{
		...
		private void OnGUI() 
		{
		    ...
		    this.isBuildAb = EditorGUILayout.Toggle("是否打包资源: ", this.isBuildAb);
			...
			if (GUILayout.Button("开始打包"))
			{
				...
				BuildHelper.Build(this.platformType, this.buildAssetBundleOptions, this.buildOptions, this.isBuildAb, this.isBuildExe, this.isContainAB);
			}
		}
