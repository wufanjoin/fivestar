...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ToyGameAttribute_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ToyGameAttribute);
            args = new Type[]{};
        ...
        static StackObject* get_Type_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ToyGameAttribute instance_of_this_method = (ETModel.ToyGameAttribute)typeof(ETModel.ToyGameAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
