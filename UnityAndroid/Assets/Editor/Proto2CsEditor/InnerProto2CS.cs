...
namespace ETEditor
{
	...
	public static class InnerProto2CS
	{
        ...
        private static readonly List<string> InnerList=new List<string>(){ "GatherInner"};
		...
		public static void Proto2CS()
		{
		    ...
		    {
		        msgOpcode.Clear();
		        Proto2CS("ETModel", $"{InnerList[i]}Message.proto", serverMessagePath, $"{InnerList[i]}Opcode", i*1000+2000);
		        GenerateOpcode("ETModel", $"{InnerList[i]}Opcode", serverMessagePath);
            }
		    //msgOpcode.Clear();
		    //Proto2CS("ETModel", "UserInnerMessage.proto", serverMessagePath, "UserInnerOpcode",2000);
		    //GenerateOpcode("ETModel", "UserInnerOpcode", serverMessagePath);
