...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_MessageExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Google.Protobuf.IMessage), typeof(System.IO.MemoryStream)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_1);
            args = new Type[]{typeof(Google.Protobuf.IMessage), typeof(System.Byte[]), typeof(System.Int32), typeof(System.Int32)};
        ...
        static StackObject* WriteTo_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.IO.MemoryStream @output = (System.IO.MemoryStream)typeof(System.IO.MemoryStream).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* MergeFrom_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.MessageExtensions.MergeFrom(@message, @data, @offset, @length);
