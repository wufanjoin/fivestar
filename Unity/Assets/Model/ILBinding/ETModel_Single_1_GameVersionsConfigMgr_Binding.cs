...
{
    unsafe class ETModel_Single_1_GameVersionsConfigMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.Single<ETModel.GameVersionsConfigMgr>);
            args = new Type[]{};
        ...
        static StackObject* get_Ins_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.Single<ETModel.GameVersionsConfigMgr>.Ins;
