...
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_RepeatedField_1_Google_Protobuf_Adapt_IMessage_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETAsyncTaskMethodBuilder<Google.Protobuf.Collections.RepeatedField<Google.Protobuf.Adapt_IMessage.Adaptor>>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ETModel.ETAsyncTaskMethodBuilder<Google.Protobuf.Collections.RepeatedField<Google.Protobuf.Adapt_IMessage.Adaptor>>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref ETModel.ETAsyncTaskMethodBuilder<Google.Protobuf.Collections.RepeatedField<Google.Protobuf.Adapt_IMessage.Adaptor>> instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETAsyncTaskMethodBuilder<Google.Protobuf.Collections.RepeatedField<Google.Protobuf.Adapt_IMessage.Adaptor>>[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ETAsyncTaskMethodBuilder<Google.Protobuf.Collections.RepeatedField<Google.Protobuf.Adapt_IMessage.Adaptor>>.Create();
