...
*/
		...
		{
			//LogMgr.Ins.LogInfo("will use file filter from user folder: " + fileFilterGroupAtUserPersonalFolder);
		...
		{
			//LogMgr.Ins.LogInfo("will use file filter from default user folder: " + fileFilterGroupAtUserPersonalFolderDefaultName);
	...
	public static FileFilterGroup GetProperFileFilterGroupToUse(string userFileFilterSavePath)
	{
		...
		//LogMgr.Ins.LogInfo("fileFilterGroupPath: " + fileFilterGroupPath);
