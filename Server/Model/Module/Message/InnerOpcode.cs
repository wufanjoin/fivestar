namespace ETModel
{
	public static partial class InnerOpcode
	{
		 ...
		 public const ushort DBSortQueryJsonRequest = 1016;
		 public const ushort DBQueryJsonResponse = 1017;
		 public const ushort ObjectAddRequest = 1018;
		 public const ushort ObjectAddResponse = 1019;
		 public const ushort ObjectRemoveRequest = 1020;
		 public const ushort ObjectRemoveResponse = 1021;
		 public const ushort ObjectLockRequest = 1022;
		 public const ushort ObjectLockResponse = 1023;
		 public const ushort ObjectUnLockRequest = 1024;
		 public const ushort ObjectUnLockResponse = 1025;
		 public const ushort ObjectGetRequest = 1026;
		 public const ushort ObjectGetResponse = 1027;
	}
}
