...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTask_1_Boolean_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ETModel.ETTask<System.Boolean>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref ETModel.ETTask<System.Boolean> instance_of_this_method)
        {
