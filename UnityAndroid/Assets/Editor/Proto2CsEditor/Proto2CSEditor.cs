...
namespace ETEditor
{
	...
	public class Proto2CSEditor : EditorWindow
	{
	    ...
	    private static readonly List<string> messageProtoList = new List<string>(){ "UserMessage", "LobbyMessage", "MatchMessage", "FriendsCircleMessage", "JoyLandlordsMessage", "CardFiveStarMessage" };
