...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Hotfix_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_OnApplicationQuit_0);
            app.RegisterCLRFieldSetter(field, set_OnApplicationQuit_0);
        ...
        static object get_OnApplicationQuit_0(ref object o)
        {
            return ((ETModel.Hotfix)o).OnApplicationQuit;
        }
        static void set_OnApplicationQuit_0(ref object o, object v)
        {
