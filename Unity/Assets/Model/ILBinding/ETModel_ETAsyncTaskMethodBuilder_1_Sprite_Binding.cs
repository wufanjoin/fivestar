...
{
    unsafe class ETModel_ETAsyncTaskMethodBuilder_1_Sprite_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETAsyncTaskMethodBuilder<UnityEngine.Sprite>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ETModel.ETAsyncTaskMethodBuilder<UnityEngine.Sprite>());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref ETModel.ETAsyncTaskMethodBuilder<UnityEngine.Sprite> instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as ETModel.ETAsyncTaskMethodBuilder<UnityEngine.Sprite>[];
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.ETAsyncTaskMethodBuilder<UnityEngine.Sprite>.Create();
